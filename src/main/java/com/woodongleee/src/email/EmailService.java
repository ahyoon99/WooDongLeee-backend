package com.woodongleee.src.email;
...
public class EmailService {
    ...
    private MimeMessage createMessage(String to, String code)throws Exception{
        ...
        message.setSubject("우동리 회원가입 이메일 인증");//제목

        String msgg="";
        msgg+= "<div style='margin:100px;'>";
        msgg+= "<h1> 안녕하세요 우동리입니다. </h1>";
        msgg+= "<br>";
        ...
        message.setFrom(new InternetAddress("woodongleee6@gmail.com","우동리"));//보내는 사람
